        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Bentuk Kejadian</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="/admin/bentukkejadian">Laporan Masuk</a></li>
                    {{-- <li><a href='/pengguna'>Laporan di TL</a></li> --}}
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href='/adminstakeholder/pemberiinformasi'>Pemberi Informasi</a></li>
                    <li><a href='/adminstakeholder/penindaklanjut'>Penindak Lanjut</a></li>
                </ul>
            </li>
    </div>
</div>
